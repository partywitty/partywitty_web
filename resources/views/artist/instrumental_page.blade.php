        ...
        <div class="box--c">
            ...
            <form id="updatedata">
                ...
                <div class="search--box">
                    ...
                    <p class="data--nfound">select maximum {{$subcategory->num_of_intrument}}</p>
                </div>
...
<script>
    ...
    function checkvalidation() {
        $.post("{{ url('get_selected_instrument') }}", {
            ...
            function(data, status) {
                if (data <= '{{$subcategory->num_of_intrument}}') {
                    window.location.href = "{{ url('subcategory-budgut/'.$subcategory_id) }}";
                } else {
                    alert('sorry, select only {{$subcategory->num_of_intrument}}');
                }
            });
    }
</script>
