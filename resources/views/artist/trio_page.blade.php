    ...
    <div class="main--box art--list">
        <div class="box--c">
            ...
            <form id="updatedata">
                ...
                <input type="hidden" name="subcategory_id" value="3">
    ...
    function checkvalidation() {
        $.post("{{ url('get_selected_instrument') }}", {
            ...
            function(data, status) {
                if (data > 1) {
                    if (data < 4) {
                        window.location.href = "{{ url('trio_budget') }}";
                    } else {
                        alert('Sorry, you can select only Three instrument.');
                    }
                } else {
                    alert('Please, select atleast two instrument');
                }
            });
    }
</script>
