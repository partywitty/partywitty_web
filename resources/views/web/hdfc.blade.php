...
<body>
    <form method="post" name="customerData" action="{{ url('ccavRequestHandler') }}">
        @csrf
        ...
        <table width="40%" height="100" border='1' align="center">
            ...
            <tr>
                <td>Merchant Id :</td>
                <td><input type="text" name="merchant_id" value="2220919" /></td>
            </tr>
            <tr>
                <td>Order Id :</td>
            ...
            <tr>
                ...
                <td><input type="text" name="billing_address" value="Room no 1101, near Railway station Ambad" />
                </td>
            </tr>
            <tr>
                <td>Billing City :</td>
