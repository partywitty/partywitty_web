                ...
                <div class="tab--style">
                    <div class="aside--box">
                        <div class="head--box">
                            ...
                            <h5 class="active"><a href="#category" class="fa--plus"></a></h5>
                        </div>
                        <div class="body--box" id="category">
                            <div class="ul--box">
                    ...
                    <div class="aside--box">
                        <div class="head--box">
                            ...
                            <h5><a href="#search" class="fa--plus"></a></h5>                   
                        </div>
                        <div class="body--box" id="search"  style="display: none;">
                            <form action="">
                                <div class="row">
                                    <div class="col-md-12">
                    ...
                    <div class="aside--box">
                        <div class="head--box">
                            ...
                            <h5 ><a href="#comments" class="fa--plus"></a></h5>                      
                        </div>
                        <div class="body--box" id="comments"  style="display: none;">
                            <div class="comments">
                                <div class="wrapper--box">
                                    <div class="icon--msz">
                    ...
                    <div class="aside--box">
                        <div class="head--box">
                            ...
                            <h5 ><a href="#calender" class="fa fa-calendar"></a></h5>                      
                        </div>
                    </div>
                    <div class="aside--box">
                        <div class="head--box">
                            <h5 class="name"> Tags </h5> 
                            <h5 ><a href="#tags" class="fa--plus"></a></h5>                      
                        </div>
                        <div class="body--box" id="tags"  style="display: none;">
                            <div class="grid--box">
