...
<section class="main--feacture artist">
    <div class="main--box">
        ...
        <div class="description--box">
            ...
            <p>We at <a href="www.partywitty.com">Party Witty</a> are Primary focused and driven towards an objective to enhance the experience for an Artist.
                <br>
                <br>
                Problem solving motive towards the points that comes across as challenges for the artist on regular basis, we have come here as a solution to all those highlighted problems.
            </p>
            <div class="border--line"></div>
        </div>
        ...
        <div class="grid--box">
            <div class="benefit--box">
                ...
                <p>All the shows and gigs will be booked real time along with the features of calendarization to have a organised work flow for an Artist at <a href="www.partywitty.com">Party witty</a></p>
            </div>
            <div class="benefit--box">
                <img src="{{url('')}}/public/user/assets/img/icon_2.png" alt="">
                <h5>UNLIMITED GIGS</h5>
                <p>Artist is not limited to countable gigs a months, it can be optimised by the number of days he has his calendar available with <a href="www.partywitty.com">Party Witty</a></p>
            </div>
            <div class="benefit--box">
                <img src="{{url('')}}/public/user/assets/img/icon_3.png" alt="">
                <h5>REFERRAL EARNING</h5>
                <p>Growth is not just limited to the number of shows done by the artist booked through <a href="www.partywitty.com">Party witty</a>
            ...
            <div class="benefit--box">
                ...
                <p>Achievement and awards will be highlighted and showcase at the elevated platform through <a href="www.partywitty.com">Party witty</a> application </p>
            </div>
            <div class="benefit--box">
                <img src="{{url('')}}/public/user/assets/img/icon_5.png" alt="">
                <h5>TIMELY PAYOUT</h5>
                <p>Challenge of payout being delayed and risk of not getting the payment at all will be 100% eliminated.. at <a href="www.partywitty.com">Party witty</a>
            ...
            <div class="benefit--box">
                ...
                <p>Growth of an artist is directly proportional to the performance and its review. We shall promote the artist with the precise algorithm designed at the back to end to digitally enhance the price for the artist at the dynamic platform -<a href="www.partywitty.com">Party witty</a> </p>
            </div>
        </div>
        <div class="description--box">
